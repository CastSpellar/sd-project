 ...
 * nao automatico de definir o formato da serializacao, redefinindo os
 * metodos ("escondidos") do interface Serializable.
...
public class FileToTransfer implements java.io.Serializable {
    ...
    private void writeObject(ObjectOutputStream oos) throws IOException {
    	...
    	//copia o conteudo do ficheiro do disco para o canal de saida
    	int n;
    ...
    private void readObject(ObjectInputStream ois) throws IOException, ClassNotFoundException {
    	...
    	// copia o conteudo do ficheiro do canal de entrada para o disco
    	byte[] buffer = new byte[1024] ;
